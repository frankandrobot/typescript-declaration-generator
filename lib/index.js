...
const createGenerators = deps.createGenerators
...
const generators = createGenerators({ts})
...
ts.tdgAst
  ...
  .map(exportsWithAst => generators.exportVariableStatement('./test/input5.ts', exportsWithAst.exportNode, exportsWithAst.ast))
  .tap(console.log)
